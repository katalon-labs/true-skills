...
- Use `katalon-trueplatform-testing` for end-to-end flows that include requirement analysis, case creation, suite management, execution, AI polling, and result reporting.
