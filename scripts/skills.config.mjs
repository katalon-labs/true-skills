...
export const INTERFACE = {
  ...
  "test-data": {
    title: "Katalon Test Data",
    short: "Design, seed, and tear down test data",
    prompt: "Which data does this case need, and how do I seed and reset it?",
    roles: ["manual tester", "automation tester"],
  },
  "exploratory-charter": {
    title: "Katalon Exploratory Charter",
    short: "Charter and run an exploratory session",
  ...
  "test-case-to-katalon-studio": {
    ...
    prompt: "Turn test case TC-1042 into a Katalon Studio test case and script.",
    roles: ["automation tester"],
  },
  "test-estimation": {
    title: "Katalon Test Estimation",
    short: "Size and resource a test cycle",
    prompt: "How long will testing this release take, and with how many people?",
    roles: ["test lead", "test manager"],
  },
  "test-reporting": {
    title: "Katalon Test Reporting",
    short: "Metrics and stakeholder reporting",
    prompt: "Build the quality summary I can present to stakeholders for this release.",
    roles: ["test lead", "test manager"],
  },
};
